...
class PercentSplitStrategy(ISplitStrategy):
    ...
    def calculate_splits(
        ...
        for i in range(len(participants) - 1):
            ...
            amount = (total * (pct / Decimal("100"))).quantize(Decimal("0.0000"), rounding=ROUND_HALF_UP)
...
class ExactSplitStrategy(ISplitStrategy):
    ...
    def calculate_splits(
        ...
        for user_id in participants:
            amount = inputs_by_user[user_id].value.quantize(Decimal("0.0000"), rounding=ROUND_HALF_UP)
